...
- Evaluate the view that think-tanks, lobbyists an pressure groups have little impact on government decisions    
...
- Evaluate the view that citizens no longer feel confident that their rights in the UK are secure and established      
...
- Evaluate the extent to which a pressure group’s access to resources is the most important factor in determining its level of influence      
- Evaluate the view that the UK is facing a participation crisis      
- Evaluate the extent to which compulsory voting and lowering the voting age may be the best way to improve participation in the UK      
...
- Evaluate the view that all main UK parties support liberal ideas (McNaughton textbook)      
...
- Evaluate the extent to which thee media can influence support for political parties      
...
- Evaluate the view that modern conservative policies do not conform to the traditional ideas of the party      
- Evaluate the extent to which the current Conservative party are more influenced by one nation principles than Thatcherism    

### Electoral systems:
- Evaluate the view that the emergence of multiple parties in the UK means that the electoral Westminster electoral system must be changed    
- Evaluate the view that various electoral systems in the UK make significant differences to party representation    
- Evaluate the extent to which the FPTP electoral system promotes strong and stable government      
- Evaluate the extent to which proportional representation promotes a democratic multi-party system      
...
- Evaluate the arguments in favour of retaining the FPTP electoral system to elect the HOC       
...
- Evaluate the impact of turnout in determining the outcomes of elections      
...
- Evaluate the extent to which the media influence the outcome of elections in the UK      
- Evaluate the extent to which election campaigns influence the outcome of the vote      
- Evaluate how far class voting remains the most important factor in determining general elections. Should refer to at least 3 enteral elections      
- Evaluate the extent to which voting behaviour had changes in the UK. Should refer to at least 3 general elections      
...
- Evaluate the extent to which right are effectively protected by the UK’s constitutional arrangements      
...
- Examine the different natures of the us and UK constitution       
- Examine the features of the us and UK supreme courts designed to ensure independence from political influence     
- Explain how the powers of the US congress and the UK parliament are limited in different ways     
- Examine the ways in which the roles of the US President and the UK prime minister are different     
- Examine ho interest groups in the USA are more effective at protecting civil rights than pressure groups in the UK     
- Examine how devolution in the UK differs from federalism in the USA   
- Analyse how the us senate has greater power than the UK HOL   
...
- Evaluate the extent to which the Republicans are now a more divided party than the democrats      
- Evaluate the extent to which local factors are more important than national factors in congressional midterm elections      
- Evaluate the extent to which the extent to which the vagueness of the constitution is beneficial      
- Evaluate the extent to which the entrenched and codified nature of the constitution is advantageous    
- Evaluate extent to which the amendment process for the constitution is failing us society      
- Evaluate the view that the us system of checks and balances has failed      
- Evaluate the extent to which constitutional federalism in the us has eroded states power      
- Evaluate the extent to which the constitution is undemocratic and needs reform      
- Evaluate the view that the strengths of the constitution outweigh the weaknesses      
- Evaluate the view that the impacts of th constitution on the us government are positive      