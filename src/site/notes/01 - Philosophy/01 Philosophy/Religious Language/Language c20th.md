...
![Religious language c20th.png](/img/user/05%20-%20Images/1.2/Religious%20language%20c20th.png)

### Key terms

| Word                        | Definition                                                                                                                                                                                                                |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Verification                | to prove an assertion true                                                                                                                                                                                                |
| Meaningful                  | makes sense                                                                                                                                                                                                               |
| Language                    | communication                                                                                                                                                                                                             |
| Univocal language           | unambiguous                                                                                                                                                                                                               |
| Equivocal language          | ambiguous — more than one meaning/interpretation                                                                                                                                                                          |
| Tautology                   | something that is the case and cannot be empirically found true/false — all bachelors are unmarried men.                                                                                                                  |
| Cognitive                   | propositions based on knowledge, and can be proven true or false through this.                                                                                                                                            |
| Non-cognitive               | propositions that cannot be proved true or false through knowledge — like ethical positions, or emotions.                                                                                                                 |
| Logical positivism          | The philosophical approach taken by the Vienna Circle. The logical positivist position is that theological language is literally meaningless, because it is neither a matter of logic nor provable by empirical evidence. |
| Verification principle      | Statements are only meaningful if they are true by definition (a tautology) or empirically verifiable. There are strong and weak forms.                                                                                   |
| Eschatological verification | Hick's view that the 'facts' of Christianity will be proved true or false at death.                                                                                                                                       |
| Blik                        | Hare's idea of a framework of interpretation/ a worldview — which is non-cognitive and non-falsifiable.                                                                                                                   |
| Falsificaiton principle     | Statements are factually significant if and only if their is some form of evidence which could, in theory, falsify it.                                                                                                    |
...
- 'God-talk is evidently nonsense', Ayer, [pg 143-146](https://peped.org/philosophicalinvestigations/extract-5-aj-ayer-god-talk-is-nonsense/) [PDF](https://antilogicalism.com/wp-content/uploads/2017/07/language-truth-and-logic.pdf)
...
**Videos**
- [all of religious language c20th explained](https://www.youtube.com/watch?v=5gAH6SiofKU)

## Summary
### Implications on religious language
